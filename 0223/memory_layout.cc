...
int main(int argc, char* argv[])
{
    ...
    std::cout << "addr  s2:" << static_cast<const void *>(s2) << std::endl; 
	std::cout << "addr &s3:" << &s3 << std::endl; 
    std::cout << "addr  s3:" << static_cast<const void *>(s3) << std::endl; 
	std::cout << "addr &s4:" << &s4 << std::endl; 
    std::cout << "addr  s4:" << static_cast<const void *>(s4) << std::endl; 
    ...
    std::cout << "addr  gs2:" << static_cast<const void *>(gs2) << std::endl; 
	std::cout << "addr &gs3:" << &gs3 << std::endl; 
    std::cout << "addr  gs3:" << static_cast<const void *>(gs3) << std::endl; 
	std::cout << "addr &gs4:" << &gs4 << std::endl; 
    std::cout << "addr  gs4:" << static_cast<const void *>(gs4) << std::endl; 
    std::cout << std::endl; 
